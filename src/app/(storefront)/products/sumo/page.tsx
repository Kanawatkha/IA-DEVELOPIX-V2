...
/**
 * @file src/app/(storefront)/products/sumo/page.tsx
 * @description Standardized, orchestrator-driven category portal for SUMO products.
...
export default function SumoPage() {
  const config = getCategoryConfig('sumo');
