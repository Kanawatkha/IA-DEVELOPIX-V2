...
export default function MissionGoPage() {
  ...
  return (
    <main className="bg-[#000000] text-[#ffffff] w-full min-h-screen font-serif">
      ...
      {/* -------------------------------------------------------------
          ...
          ------------------------------------------------------------- */}
      <section id="product-details-section" className="pt-10 pb-12 lg:pt-16 lg:pb-12 px-6 lg:px-12 bg-[#000000] text-[#ffffff] max-w-[1720px] mx-auto border-t border-hairline">
        <motion.h2 
          initial="hidden"
          whileInView="visible"
