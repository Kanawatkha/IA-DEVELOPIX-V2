 ...
 * Iterates dynamically over central CATEGORIES config metadata to display
 * representative cover graphics, release states, and links to collection hubs.
 */
  ...
  return (
    <section className="section-layout section-py section-px bg-canvas">
      ...
      >
        ...
        {/* Dynamic Category Medallions / Cards Grid */}
        <motion.div 
        ...
        >
          {CATEGORIES.map((category) => {
            ...
            const categoryHref = getCategoryPath(category.name);
