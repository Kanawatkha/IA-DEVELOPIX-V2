...
export default function MissionProStory() {
  ...
  return (
    <main className="bg-canvas text-primary w-full min-h-screen font-serif">
      ...
      <div className="w-full max-w-[3840px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-6 xl:gap-8 2xl:gap-10 px-6 lg:px-12 relative items-start pt-6 md:pt-10 lg:pt-8 pb-10 lg:pb-16">
        ...
        <ProductImageGallery images={PRODUCT_IMAGES} modelName="MISSION PRO" className="col-span-1 lg:col-span-7 xl:col-span-8" />

        {/* Right Column: Sticky Product Info Form (Takes 5 cols on lg, 4 cols on xl) */}
          <ProductInfoForm
          productId="mission-pro"
          name="MISSION PRO"
          category="MISSION"
          categoryHref="/products/mission"
          price="THB 45,000"
          description="Engineered for precision and speed. The MISSION PRO is a high-performance robot optimized for maximum agility. Built specifically to dominate in competition categories, it delivers flawless execution on the most complex trajectories."
          inStock={true}
        />
